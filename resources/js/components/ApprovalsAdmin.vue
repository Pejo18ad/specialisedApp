                ...
                <table class="table table-hover">
                  ...
                  <tbody>
                    <tr v-for="timeregistration in timeregistration" :key="timeregistration.ID">
                      ...
                      <td>
                        <i @click="editApprovalModal(timeregistration)" class="fa fa-times approvedCheckbox2" v-if="timeregistration.approval_status === 0"></i>
                        <i @click="editApprovalModal2(timeregistration)" class="fa fa-check approvedCheckbox" v-if="timeregistration.approval_status === 0"></i>
                        </td>
                    </tr>
...
import moment from 'moment';
    export default {
        ...
        methods: {
          ...
          editApprovalModal(timeregistration){
            this.$Progress.start();
            this.editMode = true;
            this.form.reset();
            this.form.fill(timeregistration);
            this.form.approval_status = 2;
          ...
          editApprovalModal2(timeregistration){
            this.$Progress.start();
            this.editMode = true;
            this.form.reset();
            this.form.fill(timeregistration);
            this.form.approval_status = 1;
          ...
          loadTimeregistration(){
            axios.get("api/timeregistrationShowApprovalsAll").then(({ data }) => (this.timeregistration = data));
          },
