                ...
                <table class="table table-hover">
                  ...
                  <tbody>
                    <tr v-for="timeregistration in timeregistration" :key="timeregistration.ID">
                      ...
                      <td><i @click="editApprovalModal(timeregistration)" class="fa fa-check approvedCheckbox" v-if="timeregistration.approval_status === 0"></i></td>
                    </tr>
    ...
    export default {
        ...
        methods: {
          ...
          loadTimeregistration(){
            axios.get("api/timeregistrationShowApprovals").then(({ data }) => (this.timeregistration = data));
          },
